...
export function ThemeSelector(props) {
  ...
  return (
    ...
    >
      ...
      >
        <LightIcon className="hidden h-4 w-4 fill-cyan-600 [[data-theme=light]_&]:block" />
        <DarkIcon className="hidden h-4 w-4 fill-cyan-600 [[data-theme=dark]_&]:block" />
                ...
                <div className="rounded-md bg-white p-1 shadow ring-1 ring-slate-900/5 dark:bg-slate-700 dark:ring-inset dark:ring-white/5">
                  <theme.icon
                    className={clsx(
                      'h-4 w-4',
                      selected
                        ? 'fill-cyan-600 dark:fill-cyan-600'
                        : 'fill-slate-400'
                    )}
                  />
                </div>
